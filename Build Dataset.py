...
while True:
    ...
    if num_frames < 60:
        ...
        if num_frames <= 59:
            ...
            cv2.putText(frame_copy, "Setting Background", (80, 400), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,0,255), 2)
        ...
        cv2.putText(frame_copy, "Set Hand Gesture" + str(element), (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 300:
                cv2.imwrite('/home/r0b0shubham96/Desktop/Hand Gesture/Train/C' + str(num_imgs_taken) + '.jpg', thresholded)
            else:
                break
            num_imgs_taken +=1
        else:
